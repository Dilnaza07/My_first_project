...
//    dateFashion(5, 5) → 1
    ...
    public static void main(String[] args) {
        int isDateFashion = dateFashion(5, 10);
        int isDateFashion1 = dateFashion(2, 10);
        int isDateFashion2 = dateFashion(6, 6);
        System.out.println(isDateFashion);
        System.out.println(isDateFashion1);
        System.out.println(isDateFashion2);
    }
    ...
    public static int dateFashion2(int you, int date) {
        if (you <= 2 || date <= 2) {
            return 0;
